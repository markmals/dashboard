...
export function Dialog({
    ...
    return (
        <ModalOverlay
            className={cx(
                "fixed inset-0 z-50 w-screen overflow-y-auto bg-zinc-950/25 px-2 py-2 focus:outline-0 sm:px-6 sm:py-8 lg:px-8 lg:py-16 dark:bg-zinc-950/50",
...
export function DialogDescription({
    ...
    return <Text {...props} className={cx(className, "mt-2 text-pretty")} />;
}
