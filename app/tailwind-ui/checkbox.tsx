...
const base = [
    ...
    // Border
    "border border-zinc-950/15 group-data-selected:border-transparent group-data-hovered:group-data-selected:border-transparent group-data-hovered:border-zinc-950/30 group-data-selected:bg-(--checkbox-checked-border)",
    ...
    "dark:group-data-disabled:border-white/20 dark:group-data-disabled:bg-white/2.5 dark:group-data-disabled:[--checkbox-check:var(--color-white)]/50 dark:group-data-selected:group-data-disabled:after:hidden",
    // Forced colors mode
...
export function Checkbox({
    ...
    color?: Color;
    className?: string;
} & Omit<React.ComponentPropsWithoutRef<typeof RACCheckbox>, "className" | "children">) {
    return (
        <RACCheckbox
            data-slot="control"
            {...props}
