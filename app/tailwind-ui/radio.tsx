...
const base = [
    ...
    // Border
    "border border-zinc-950/15 group-data-selected:border-transparent group-data-hovered:group-data-selected:border-transparent group-data-hovered:border-zinc-950/30 group-data-selected:bg-(--radio-checked-border)",
    "dark:border-white/15 dark:group-data-selected:border-white/5 dark:group-data-hovered:group-data-selected:border-white/5 dark:group-data-hovered:border-white/30",
    ...
    "[--radio-indicator:transparent] group-data-selected:[--radio-indicator:var(--radio-checked-indicator)] group-data-hovered:group-data-selected:[--radio-indicator:var(--radio-checked-indicator)] group-data-hovered:[--radio-indicator:var(--color-zinc-900)]/10",
    // Indicator color (dark mode)
    "dark:group-data-hovered:group-data-selected:[--radio-indicator:var(--radio-checked-indicator)] dark:group-data-hovered:[--radio-indicator:var(--color-zinc-700)]",
    // Focus ring
    "group-data-focus-visible:outline-solid group-data-focus-visible:outline-2 group-data-focus-visible:outline-offset-2 group-data-focus-visible:outline-blue-500",
    // Disabled state
